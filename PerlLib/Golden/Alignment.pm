 ...
 unless ( -s $gmap_output ) {
  ...
  foreach my $file (@$output_files_ref) {
   ...
   while ( my $record = <IN> ) {
    ...
    # The first record from each *.uniq file is the GMAP header block
    # ("##gff-version 3\n# Generated by GMAP..."), which carries no
    # feature lines and leaves @corrected_record_data empty after the
    # comment-skip above. Skip such header-only / data-less records.
    next if scalar(@corrected_record_data) < 2;
