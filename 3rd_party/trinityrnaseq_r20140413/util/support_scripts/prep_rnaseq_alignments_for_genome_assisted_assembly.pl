...
sub prep_read_partitions {
    ...
    ## define fragments
    my $cmd = "$UTIL_DIR/SAM_to_frag_coords.pl --sort_buffer $sort_buffer --sam $sam --min_insert_size 1 --max_insert_size $max_intron_length "; ## writes file: $sam_file.frag_coords
