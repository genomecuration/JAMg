...
#
##############################################################
# Pass on additional parameters to PtR for generating heatmap by including '--' followed by PtR params..
#
#    ex.
#          analyze_diff_expr.pl --matrix my.TMM.fpkm.matrix -- --gene_dist euclidean --sample_dist euclidean
#
##############################################################
