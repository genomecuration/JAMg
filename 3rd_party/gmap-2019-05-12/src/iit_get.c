static char rcsid[] = "$Id: iit_get.c 215546 2018-05-31 01:01:48Z twu $";
#ifdef HAVE_CONFIG_H
#include <config.h>
#endif
...
main (int argc, char *argv[]) {
  ...
  char *line, *nocomment, *query, *typestring;
  int line_length;
  int typeint, *types, c;
...
#endif
      nocomment = (char *) MALLOC((line_length+1)*sizeof(char));
      strcpy(nocomment,line);
