static char rcsid[] = "$Id: stage1.c 218185 2019-01-17 13:05:01Z twu $";
#ifdef HAVE_CONFIG_H
#include <config.h>
#endif
...
Stage1_setup (Width_T index1part_in, Chrpos_T maxextension_in, Chrpos_T maxtotallen_bound_in,
  ...
  oligobase_mask = ~(~ (Oligospace_T) 0 << 2*index1part_in);
#else
...
/* Previously had parameter stage1_stutter_sizelimit */
static List_T
stutter (List_T gregionlist, T this, Width_T matchsize,
  ...
  while (Block_next_5(this->block5,genestrand) == true && 
    ...
    if (this->processedp[this->querystart] == false) {
      Block_process_oligo_5(&(this->plus_positions[this->querystart]),&(this->plus_npositions[this->querystart]),
			    &(this->minus_positions[this->querystart]),&(this->minus_npositions[this->querystart]),
			    this->block5,indexdb_fwd,indexdb_rev/*,stage1_stutter_sizelimit*/);
  ...
  while (Block_next_3(this->block3,genestrand) == true && 
	 stutterdist3 < maxbases && n3hits < stutterhits) {
    this->queryend = Block_querypos(this->block3);
    if (this->processedp[this->queryend] == false) {
      Block_process_oligo_3(&(this->plus_positions[this->queryend]),&(this->plus_npositions[this->queryend]),
			    &(this->minus_positions[this->queryend]),&(this->minus_npositions[this->queryend]),
			    this->block3,indexdb_fwd,indexdb_rev/*,stage1_stutter_sizelimit*/);
...
/* Previously had parameer stage1_fillin_sizelimit */
static List_T
fill_in_5 (List_T gregionlist, T this, Width_T matchsize, List_T dangling3,
  ...
  while (Block_next_5(this->block5,genestrand) == true && 
    ...
    if (this->processedp[this->querystart] == false) {
      Block_process_oligo_5(&(this->plus_positions[this->querystart]),&(this->plus_npositions[this->querystart]),
			    &(this->minus_positions[this->querystart]),&(this->minus_npositions[this->querystart]),
			    this->block5,indexdb_fwd,indexdb_rev/*,stage1_fillin_sizelimit*/);
...
fill_in_3 (List_T gregionlist, T this, Width_T matchsize, List_T dangling5, 
  ...
  while (Block_next_3(this->block3,genestrand) == true && 
    ...
    if (this->processedp[this->queryend] == false) {
      Block_process_oligo_3(&(this->plus_positions[this->queryend]),&(this->plus_npositions[this->queryend]),
			    &(this->minus_positions[this->queryend]),&(this->minus_npositions[this->queryend]),
			    this->block3,indexdb_fwd,indexdb_rev/*,stage1_fillin_sizelimit*/);
...
sample (T this, Indexdb_T indexdb_fwd, Indexdb_T indexdb_rev, int nskip) {
  ...
  while (Block_next_5(this->block5,genestrand) == true) {
    ...
    if (this->processedp[this->querystart] == false) {
      Block_process_oligo_5(&(this->plus_positions[this->querystart]),&(this->plus_npositions[this->querystart]),
			    &(this->minus_positions[this->querystart]),&(this->minus_npositions[this->querystart]),
			    this->block5,indexdb_fwd,indexdb_rev/*,stage1_sample_sizelimit*/);
  ...
  while (Block_next_3(this->block3,genestrand) == true) {
    ...
    if (this->processedp[this->queryend] == false) {
      Block_process_oligo_3(&(this->plus_positions[this->queryend]),&(this->plus_npositions[this->queryend]),
			    &(this->minus_positions[this->queryend]),&(this->minus_npositions[this->queryend]),
			    this->block3,indexdb_fwd,indexdb_rev/*,stage1_sample_sizelimit*/);
...
/* Previously had parameter stage1_firstpair_sizelimit */
static List_T
find_first_pair (bool *foundpairp, List_T gregionlist, T this, Width_T matchsize,
  ...
  *foundpairp = false;
  while (!donep && (*foundpairp) == false) {
    if (n5hits <= n3hits) {
      if (Block_next_5(this->block5,genestrand) == false) {
	donep = true;
      } else {
	this->querystart = Block_querypos(this->block5);
	if (this->processedp[this->querystart] == false) {
	  Block_process_oligo_5(&(this->plus_positions[this->querystart]),&(this->plus_npositions[this->querystart]),
				&(this->minus_positions[this->querystart]),&(this->minus_npositions[this->querystart]),
				this->block5,indexdb_fwd,indexdb_rev/*,stage1_firstpair_sizelimit*/);
#ifdef PMAP
	...
	if (nnew > 0) {
      ...
      if (Block_next_3(this->block3,genestrand) == false) {
	donep = true;
      } else {
	this->queryend = Block_querypos(this->block3);
	if (this->processedp[this->queryend] == false) {
	  Block_process_oligo_3(&(this->plus_positions[this->queryend]),&(this->plus_npositions[this->queryend]),
				&(this->minus_positions[this->queryend]),&(this->minus_npositions[this->queryend]),
				this->block3,indexdb_fwd,indexdb_rev/*,stage1_firstpair_sizelimit*/);
#ifdef PMAP
...
static void
read_oligos (T this, Sequence_T queryuc, int genestrand) {
  Reader_T reader;
  int querypos;
  ...
  while ((last_state = Oligo_next_5(last_state,&querypos,
#ifdef PMAP
				    &aaindex,
#else
				    &forward,&revcomp,
#endif
				    reader,genestrand)) != DONE) {
...
Stage1_compute (bool *lowidentityp, Sequence_T queryuc,
  ...
  *lowidentityp = false;
  ...
  read_oligos(this,queryuc,genestrand);
#ifdef PMAP
  ...
  if (gregionlist == NULL ||
    ...
    minus_segments = find_segments(&minus_nsegments,this->minus_positions,this->minus_npositions,
				   ...
				   /*threshold_score*/27);
#else
    sample_oligos_nolimit(this,indexdb_fwd,indexdb_rev,this->querylength,/*oligobase*/index1part);
    collapse_diagonals(this->plus_positions,this->plus_npositions,
...
Stage1_compute_nonstranded (bool *lowidentityp, Sequence_T queryuc,
  ...
  *lowidentityp = false;
  ...
  read_oligos(this_fwd,queryuc,/*genestrand*/+1);
#ifdef PMAP
  ...
  read_oligos(this_rev,queryrc,/*genestrand*/+2);
#ifdef PMAP
  ...
  gregionlist = scan_ends(&shortseqp,/*second_pass_p*/false,gregionlist,this_rev,
			  indexdb_rev,indexdb_rev,/*genestrand*/+2,chromosome_iit,chrsubset_start,chrsubset_end,
			  matchpool,stutterhits,diagnostic,/*iteratep*/false);
  ...
  if (gregionlist == NULL || Gregion_best_weight(gregionlist) < SUFFICIENT_FIRST_WEIGHT) {
	...
	gregionlist = find_good_paths(gregionlist,/*nexons*/k,plus_prev_rev[k],plus_scores_rev[k],
				      ...
				      trimstart,trimend,/*plusp*/true,/*genestrand*/+2);
      }
	...
	gregionlist = find_good_paths(gregionlist,/*nexons*/k,minus_prev_rev[k],minus_scores_rev[k],
				      ...
				      chromosome_iit,this_rev->querylength,
				      trimstart,trimend,/*plusp*/false,/*genestrand*/+2);
      }
    }
