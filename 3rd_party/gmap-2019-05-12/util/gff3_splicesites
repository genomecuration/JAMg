...
if (defined($opt_d)) {
	...
	if (0) {
	    ...
	    $FP = new IO::File("| /mnt/nfs/home/30042108/software/JAMg/3rd_party/gmap-2019-05-12/bin/get-genome -D $opt_D -d $opt_d > get-genome.out");
	} else {
	    $FP = new IO::File("| /mnt/nfs/home/30042108/software/JAMg/3rd_party/gmap-2019-05-12/bin/get-genome -d $opt_d > get-genome.out");
	}
