...
#    Revision 1.11  2013/11/06 19:01:26  rhubley
...
#  $Name: open-4-0-5 $ macro will be blank and thus we use
#  this as the development version.
#
my $CVSTag = '$Name: open-4-0-5 $';
my $version;
if ( $CVSTag =~ /\$\s*Name:\s*open-(\S+)\s*\$/ ) {
  ...
  $version =
'development-$Id: getRepeatMaskerBatch.pl,v 1.11 2013/11/06 19:01:26 rhubley Exp $';
}
