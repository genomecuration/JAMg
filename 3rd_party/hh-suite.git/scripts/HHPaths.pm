...
our $execdir = $RealBin."/../dependencies/psipred2/bin";  # path to PSIPRED V2 binaries
our $datadir = $RealBin."/../dependencies/psipred2/data"; # path to PSIPRED V2 data files
our $ncbidir = $RealBin."/../dependencies/blast-2.2.26/bin";    # path to NCBI binaries (for PSIPRED in addss.pl)
...
our $pdbdir  =  $RealBin."/../dependencies/pdb/derived";           # where are the pdb files? (pdb/divided directory will also work)
our $dsspdir =  $RealBin."/../dependencies/dssp-2.2.1/data";          # where are the dssp files? Used in addss.pl
our $dssp    =  $RealBin."/../dependencies/dssp-2.2.1/mkdssp";  # where is the dssp binary? Used in addss.pl
##############################################################################################

# The lines below probably do not need to be changed

# Setting paths for hh-suite perl scripts
our $hhlib    = $RealBin."/../";     # main hh-suite directory
