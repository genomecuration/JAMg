...
if (defined($opt_d)) {
	...
	if (0) {
	    ...
	    $FP = new IO::File("| /home/pap056/workspace/transcripts4community/jamg/3rd_party/gmap/../bin/get-genome -D $opt_D -d $opt_d > get-genome.out");
	} else {
	    $FP = new IO::File("| /home/pap056/workspace/transcripts4community/jamg/3rd_party/gmap/../bin/get-genome -d $opt_d > get-genome.out");
	}
