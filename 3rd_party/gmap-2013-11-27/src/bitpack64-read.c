static char rcsid[] = "$Id: bitpack64-read.c 115652 2013-11-19 19:31:22Z twu $";
#ifdef HAVE_CONFIG_H
#include <config.h>
#endif
...
static UINT4 *bitpackpages;	/* A list of b-mers (12-mers by default), ending with -1U */
...
Bitpack64_offsetptr (Positionsptr_T *end0, Storedoligomer_T oligo) {
  ...
  bmer = oligo/OFFSETSCOMP_BLOCKSIZE;
...
Bitpack64_block_offsets_huge (Hugepositionsptr_T *offsets, UINT4 *bitpackptrs, Offsetscomp_T *offsetscomp,
  ...
  UINT4 *info, nwritten;
  Storedoligomer_T bmer;
  Hugepositionsptr_T offset0, offset1, temp;
  int packsize, k;
#ifdef HAVE_SSE2
  __m128i diffs[8], *bitpack;
  UINT4 *_diffs;
