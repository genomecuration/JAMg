...
if (defined($opt_d)) {
	...
	if (0) {
	    ...
	    $FP = new IO::File("| /home/pap056/workspace/transcripts4community/jamg/3rd_party/gmap-2013-10-28/../../bin/get-genome -D $opt_D -d $opt_d > get-genome.out");
	} else {
	    $FP = new IO::File("| /home/pap056/workspace/transcripts4community/jamg/3rd_party/gmap-2013-10-28/../../bin/get-genome -d $opt_d > get-genome.out");
	}
