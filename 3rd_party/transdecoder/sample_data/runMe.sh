...
if [ $1 ]; then
 ## checking for PFAM
 ../transcripts_to_best_scoring_ORFs.pl -t transcripts.fasta --workdir transdecoder.tmp.pfam --search_pfam $1
else
 ## no PFAM
 ../transcripts_to_best_scoring_ORFs.pl -t transcripts.fasta --workdir transdecoder.tmp.nopfam
fi
