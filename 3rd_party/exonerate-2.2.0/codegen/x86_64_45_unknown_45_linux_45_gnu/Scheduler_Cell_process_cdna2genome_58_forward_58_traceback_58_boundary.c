...
void Scheduler_Cell_process_cdna2genome_58_forward_58_traceback_58_boundary(Scheduler_Cell *cell,
        Scheduler_Row *row,
...
&& (cell->score[13][0]
   < span_data->curr_span_seed->score)){
cell->score[13][0] = span_data->curr_span_seed->score;
cell->score[13][1] = span_data->curr_span_seed->max;
cell->score[13][2] = span_data->curr_span_seed->seed_id;
cell->traceback[13] = Scheduler_Cell_add_span(
    span_data->curr_span_seed->cell,
    spair->straceback,
    spair->scheduler->span_map[13],
    src_query_pos
    -span_data->curr_span_seed->query_entry,
    src_target_pos
    -span_data->curr_span_seed->target_entry);
cell->score[13][3] = span_data->curr_span_seed->shadow_data[0];
}
}
shadow = transition->dst_shadow_list->pdata[0];
shadow->end_func(cell->score[13][3],
    dst_query_pos, dst_target_pos,
    spair->user_data);
transition_score = C4_Calc_score(transition->calc,
   src_query_pos, src_target_pos,
...
span_seed.score = cell->score[13][0];
if(span_seed.score >= 0){
span_seed.max = cell->score[13][1];
span_seed.seed_id = cell->score[13][2];
span_seed.cell = cell->traceback[13];
span_seed.query_entry = src_query_pos;
span_seed.target_entry = src_target_pos;
span_seed.shadow_data = &cell->score[13][3];
Scheduler_SpanData_submit(span_data,
    &span_seed, spair->span_seed_cache, spair);
...
span_data = spair->span_history->span_data[3];
span_seed.score = cell->score[17][0];
if(span_seed.score >= 0){
span_seed.max = cell->score[17][1];
span_seed.seed_id = cell->score[17][2];
span_seed.cell = cell->traceback[17];
span_seed.query_entry = src_query_pos;
span_seed.target_entry = src_target_pos;
span_seed.shadow_data = &cell->score[17][3];
Scheduler_SpanData_submit(span_data,
    &span_seed, spair->span_seed_cache, spair);
...
if(cell->permit_span_thaw){
span_data =
    spair->span_history->span_data[3];
Scheduler_SpanData_get_curr(
  span_data, spair->span_seed_cache,
  cell->query_pos, row->target_pos,
  spair->straceback);
...
&& (cell->score[17][0]
   < span_data->curr_span_seed->score)){
cell->score[17][0] = span_data->curr_span_seed->score;
cell->score[17][1] = span_data->curr_span_seed->max;
cell->score[17][2] = span_data->curr_span_seed->seed_id;
cell->traceback[17] = Scheduler_Cell_add_span(
    span_data->curr_span_seed->cell,
    spair->straceback,
    spair->scheduler->span_map[17],
    src_query_pos
    -span_data->curr_span_seed->query_entry,
    src_target_pos
    -span_data->curr_span_seed->target_entry);
cell->score[17][3] = span_data->curr_span_seed->shadow_data[0];
}
}
shadow = transition->dst_shadow_list->pdata[0];
shadow->end_func(cell->score[17][3],
    dst_query_pos, dst_target_pos,
    spair->user_data);
transition_score = C4_Calc_score(transition->calc,
   src_query_pos, src_target_pos,
...
Scheduler_Cell_assign(spair,
    ...
    dst_query_pos, dst_target_pos);
end_of_transition_7:
span_data = spair->span_history->span_data[4];
span_seed.score = cell->score[21][0];
if(span_seed.score >= 0){
span_seed.max = cell->score[21][1];
span_seed.seed_id = cell->score[21][2];
span_seed.cell = cell->traceback[21];
span_seed.query_entry = src_query_pos;
span_seed.target_entry = src_target_pos;
span_seed.shadow_data = &cell->score[21][3];
Scheduler_SpanData_submit(span_data,
    &span_seed, spair->span_seed_cache, spair);
...
if(cell->permit_span_thaw){
span_data =
    spair->span_history->span_data[4];
Scheduler_SpanData_get_curr(
  span_data, spair->span_seed_cache,
  cell->query_pos, row->target_pos,
  spair->straceback);
...
&& (cell->score[21][0]
   < span_data->curr_span_seed->score)){
cell->score[21][0] = span_data->curr_span_seed->score;
cell->score[21][1] = span_data->curr_span_seed->max;
cell->score[21][2] = span_data->curr_span_seed->seed_id;
cell->traceback[21] = Scheduler_Cell_add_span(
    span_data->curr_span_seed->cell,
    spair->straceback,
    spair->scheduler->span_map[21],
    src_query_pos
    -span_data->curr_span_seed->query_entry,
    src_target_pos
    -span_data->curr_span_seed->target_entry);
cell->score[21][3] = span_data->curr_span_seed->shadow_data[0];
}
}
shadow = transition->dst_shadow_list->pdata[0];
shadow->end_func(cell->score[21][3],
    dst_query_pos, dst_target_pos,
    spair->user_data);
transition_score = C4_Calc_score(transition->calc,
   src_query_pos, src_target_pos,
