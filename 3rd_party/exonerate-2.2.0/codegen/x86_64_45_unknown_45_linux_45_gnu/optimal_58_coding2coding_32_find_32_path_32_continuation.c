...
/* Viterbi model:
 * [optimal_58_coding2coding_32_find_32_path_32_continuation]
 *
 * max query advance: 3
...
C4_Score optimal_58_coding2coding_32_find_32_path_32_continuation(C4_Model *model, Region *region,               Viterbi_Data *vd, SubOpt_Index *soi,           gpointer user_data){
