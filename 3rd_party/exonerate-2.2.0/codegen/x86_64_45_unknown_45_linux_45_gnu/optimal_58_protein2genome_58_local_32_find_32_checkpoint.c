 ...
 *
 * Model: Copy:protein2genome:local
 */
...
/* Viterbi model:
 * [optimal_58_protein2genome_58_local_32_find_32_checkpoint]
 *
 * max query advance: 1
...
C4_Score optimal_58_protein2genome_58_local_32_find_32_checkpoint(C4_Model *model, Region *region,               Viterbi_Data *vd, SubOpt_Index *soi,           gpointer user_data){
