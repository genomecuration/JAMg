...
/* Viterbi model:
 * [optimal_58_ungapped_58_protein2protein_32_find_32_score]
 *
 * max query advance: 1
...
C4_Score optimal_58_ungapped_58_protein2protein_32_find_32_score(C4_Model *model, Region *region,               Viterbi_Data *vd, SubOpt_Index *soi,           gpointer user_data){
