...
/* Viterbi model:
 * [optimal_58_affine_58_overlap_58_dna2dna_32_find_32_path]
 *
 * max query advance: 1
...
C4_Score optimal_58_affine_58_overlap_58_dna2dna_32_find_32_path(C4_Model *model, Region *region,               Viterbi_Data *vd, SubOpt_Index *soi,           gpointer user_data){
